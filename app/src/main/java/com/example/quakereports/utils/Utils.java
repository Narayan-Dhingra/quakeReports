package com.example.quakereports.utils;
...
public final class Utils {
    ...
    public static ArrayList<EarthQuake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                earthquakes.add(new EarthQuake(place, time, magnitude, url));
    ...
    public static Map<String,String> convertUnixTime(long time) {
        Date date = new Date(time);
        SimpleDateFormat dateFormat = new SimpleDateFormat("MMM dd, yyyy");
        SimpleDateFormat timeFormat = new SimpleDateFormat("hh:mm a");

        Map<String,String> dateAndTime = new HashMap<>();
        dateAndTime.put("date", dateFormat.format(date));
        dateAndTime.put("time", timeFormat.format(date));
